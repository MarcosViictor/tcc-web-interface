...
import { HardHat, ArrowLeft, Eye, EyeOff, Truck, AlertCircle } from "lucide-react"
        ...
        <Card className="border-2">
          <CardHeader className="text-center pb-6">
            <div className="mx-auto mb-4 h-20 w-20 rounded-full bg-success/10 flex items-center justify-center">
              <HardHat className="h-10 w-10 text-success" />
            </div>
            <CardTitle className="text-2xl">Motorista/Operador</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="#" className="text-success hover:underline">
                  Esqueceu a senha?
                </Link>
              </div>

              <Button type="submit" className="w-full bg-success hover:bg-success/90" size="lg" disabled={isLoading}>
            ...
            <div className="mt-6 pt-6 border-t">
              <div className="bg-success/5 rounded-lg p-4">
                ...
                <ul className="text-sm space-y-1 text-muted-foreground">
                  <li>• Registre o início da jornada</li>
                  <li>• Atualize o status do equipamento</li>
